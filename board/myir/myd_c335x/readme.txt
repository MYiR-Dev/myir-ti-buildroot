...
Introduction
==============
To be able to use MYD-C335X board of MYIR with the images generated by
...
3. Boot from Ethernet with NFS
  ...
  - setenv ipaddr 192.168.1.100 ( set the ipaddr of myd_c335x board)
...
4. Boot from Ethernet with ramdisk
  ...
  - tftpboot ${fdtaddr} myd_c335x.dtb  ( myd_c335x.dtb was copied to tftp server root directory)
